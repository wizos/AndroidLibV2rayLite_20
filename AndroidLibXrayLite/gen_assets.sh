...
download_dat () {
	wget https://raw.githubusercontent.com/2dust/AndroidLibXrayLite/main/assets/geoip.dat -O -> $ASSETS_DIR/geoip.dat
	wget https://raw.githubusercontent.com/2dust/AndroidLibXrayLite/master/assets/geosite.dat -O -> $ASSETS_DIR/geosite.dat
